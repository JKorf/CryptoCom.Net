...
GitHub Copilot and Cursor instructions are also provided in `.github/copilot-instructions.md` and `.cursor/rules/cryptocom-net.mdc`; both point back to the root AI context files.
...
* Version 3.9.0 - 24 Mar 2026
    ...
    * Notes for updating:
        * Update ApiCredentials to CryptoComCredentials for authentication, i.e. `ApiCredentials = new ApiCredentials(..)` => `ApiCredentials = new CryptoComCredentials(..)`
