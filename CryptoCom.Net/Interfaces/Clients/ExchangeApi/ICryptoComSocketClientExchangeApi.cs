...
namespace CryptoCom.Net.Interfaces.Clients.ExchangeApi
{
    ...
    public interface ICryptoComSocketClientExchangeApi : ISocketApiClient, IDisposable
    {
        ...
        /// <param name="ct">Cancellation token</param>
        Task<CallResult<CallResult<CryptoComOrderResult>[]>> PlaceMultipleOrdersAsync(IEnumerable<CryptoComOrderRequest> orders, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<CallResult<CryptoComCancelOrderResult[]>> CancelOrdersAsync(IEnumerable<CryptoComCancelOrderRequest> orders, CancellationToken ct = default);
