...
namespace CryptoCom.Net.Interfaces.Clients
{
    ...
    public interface ICryptoComUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, CryptoComEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        ICryptoComRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, CryptoComEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        ICryptoComSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, CryptoComEnvironment? environment = null);
    }
}