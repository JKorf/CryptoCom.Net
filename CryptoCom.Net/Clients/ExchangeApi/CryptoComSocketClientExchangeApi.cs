...
namespace CryptoCom.Net.Clients.ExchangeApi
{
    ...
    internal partial class CryptoComSocketClientExchangeApi : SocketApiClient, ICryptoComSocketClientExchangeApi
    {
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComTicker>>(_logger, symbols.Select(x => "ticker." + x).ToArray(), x => onMessage(x.As(x.Data.Data.First())), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComTrade>>(_logger, symbols.Select(x => "trade." + x).ToArray(), x => onMessage(x.As(x.Data.Data)), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComKline>>(_logger, symbols.Select(x => $"candlestick.{EnumConverter.GetString(interval)}.{x}").ToArray(),
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComValuation>>(_logger, symbols.Select(x => "index." + x).ToArray(), x => onMessage(x.As(x.Data.Data.First())), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComValuation>>(_logger, symbols.Select(x => "mark." + x).ToArray(), x => onMessage(x.As(x.Data.Data.First())), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComValuation>>(_logger, symbols.Select(x => "settlement." + x).ToArray(), x => onMessage(x.As(x.Data.Data.First())), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComValuation>>(_logger, new[] { "settlement" }, x => onMessage(x.As(x.Data.Data.First())), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComValuation>>(_logger, symbols.Select(x => "funding." + x).ToArray(), x => onMessage(x.As(x.Data.Data.First())), false);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComValuation>>(_logger, symbols.Select(x => "estimatedfunding." + x).ToArray(), x => onMessage(x.As(x.Data.Data.First())), true);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/market"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComUserTrade>>(_logger, symbols.Select(x => "user.trade." + x).ToArray(), x => onMessage(x.As(x.Data.Data)), true);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/user"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComUserTrade>>(_logger, ["user.trade"], x => onMessage(x.As(x.Data.Data)), true);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/user"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComBalances>>(_logger, ["user.balance"], x => onMessage(x.As(x.Data.Data.First())), true);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/user"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComPosition>>(_logger, ["user.positions"], x => onMessage(x.As(x.Data.Data)), true);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/user"), subscription, ct).ConfigureAwait(false);
        }
        ...
        {
            var subscription = new CryptoComSubscription<IEnumerable<CryptoComBalancePositionUpdate>>(_logger, ["user.position_balance"], x => onMessage(x.As(x.Data.Data.First())), true);
            return await SubscribeAsync(BaseAddress.AppendPath("exchange/v1/user"), subscription, ct).ConfigureAwait(false);
        }
