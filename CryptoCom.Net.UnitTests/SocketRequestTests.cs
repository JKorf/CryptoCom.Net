...
namespace CryptoCom.Net.UnitTests
{
    ...
    {
        private CryptoComSocketClient CreateClient()
        {
        ...
        public async Task ValidateExchangeApiCalls()
        {
            ...
            await tester.ValidateAsync(CreateClient(), client => client.ExchangeApi.GetBalancesAsync(), "GetBalances", nestedJsonProperty: "result.data");
            await tester.ValidateAsync(CreateClient(), client => client.ExchangeApi.GetPositionsAsync(), "GetPositions", nestedJsonProperty: "result.data");
            await tester.ValidateAsync(CreateClient(), client => client.ExchangeApi.PlaceOrderAsync("ETH_USDT", Enums.OrderSide.Buy, OrderType.Limit, 1), "PlaceOrder", nestedJsonProperty: "result");
            await tester.ValidateAsync(CreateClient(), client => client.ExchangeApi.CancelOrderAsync("123"), "CancelOrder", nestedJsonProperty: "result");
